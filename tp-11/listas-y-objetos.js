...
function promedioEdades(listaDePersonas) {
 return listadepersonas.reduce((acum, persona) => acum + persona.edad, 0) / listaDePersonas.length;
}
...
function laPersonaMayor(listaDePersonas) {
    return listaDePersonas.reduce((personaMayor, persona) => {
        return persona.edad > personaMayor.edad ? persona : personaMayor;
    });
}
